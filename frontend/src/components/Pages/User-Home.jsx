...
import MapComponent from '../mini-components/Map-test';
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between',  gap: '10px' }}>
      ...
      <div style={cardsContainerStyle}>
        ...
        {/* Uncomment if "Report an Issue" is needed */}
        {/* <h4 className="text-l font-semibold text-black mb-2">Report an Issue</h4>
        <div style={cardStyle}>
          <Textarea placeholder="Enter your issue here..." className="w-full" />
          <Button style={{ marginTop: '20px', backgroundColor: 'green', color: 'white' }} className="w-full">Submit</Button>
        </div> */}
      </div>
    </div>
  );
